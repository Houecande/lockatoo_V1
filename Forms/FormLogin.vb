...
Public Class FrmLogin
    ...
    Private Sub cboxAffichage_CheckedChanged(sender As Object, e As EventArgs) Handles cboxaffichage.CheckedChanged
        ' Si coché (True) : UseSystemPasswordChar devient False (Affiche le texte)
        ' Si décoché (False) : UseSystemPasswordChar devient True (Masque le texte)
        txtPassword.UseSystemPasswordChar = Not cboxaffichage.Checked

        ' Forcer le focus pour éviter les bugs d'affichage
        txtPassword.Focus()
    End Sub
    ...
    Private Sub btnSeConnecter_Click(sender As Object, e As EventArgs) _
        ...
        If email = "Adresse email" OrElse String.IsNullOrEmpty(email) OrElse
           mdp = "Mot de passe" OrElse String.IsNullOrEmpty(mdp) Then
    ...
    Private Sub AfficherErreur(message As String)
        ...
        ' Remettre focus sur password sans effacer email
        If txtPassword.Text <> "Mot de passe" Then
            txtPassword.Clear()
        End If
        txtPassword.Focus()
    End Sub
